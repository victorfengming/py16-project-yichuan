...
//				});
				...
				SKUTableDom += '<tr propvalids=\''+propvalids+'\' propids=\''+propIdArr.toString()+'\' propvalnames=\''+propvalnameArr.join(";")+'\'  propnames=\''+propNameArr.join(";")+'\' class="sku_table_tr">'+currRowDoms+'<td><input type="text" class="setting_sku_price" name="sku_price" style="color:black;" value="'+alreadySetSkuPrice+'"/></td><td><input type="text" class="setting_sku_stock" name="sku_stock" style="color:black;" value="'+alreadySetSkuStock+'"/></td></tr>';
			}
			SKUTableDom += "</table>";
		}
